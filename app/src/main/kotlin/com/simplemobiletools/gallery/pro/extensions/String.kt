...
fun String.shouldFolderBeVisible(
    ...
    return if (!showHidden && containsNoMedia) {
        ...
        var containsNoMediaOrDot = contains("/.")
...
fun String.getDistinctPath(): String {
    return try {
        File(this).canonicalPath.lowercase(Locale.ROOT)
    } catch (e: IOException) {
...
fun String.doesThisOrParentHaveNoMedia(folderNoMediaStatuses: java.util.HashMap<String, Boolean>, callback: ((path: String, hasNoMedia: Boolean) -> Unit)?) =
